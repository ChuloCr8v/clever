  ...
  return (
    <AnimatePresence>
      <div className="overflow-hidden flex items-center justify-center min-h-screen w-full ">
        <motion.section
          className="pt-24 pb-32 px-6 w-full flex items-center justify-center"
        ...
        >
          <div className="wrapper max-w-7xl xl:grid grid-cols-2 gap-24">
            ...
            <div className="form mt-24 xl:mt-0 border dark:border-gray-500 border-gray-400 rounded p-3 pb-12">
              <form
                action={"/"}
                name="contact clever"
                method="POST"
